...
public class Fcade {
    ...
    public Response<String> printPersonalData(){
        String data = employeeController.printPersonalData();
        return new Response<String>(data);
    }

    public Response<String> printConstraints() {
    ...
    public Response<String> suggestEmployees(String jobTitle, int day, int shiftTime){
    ...
    public Response<String> getPossibleEmployees(Date shiftDate, String shiftTime, String jobTitle) {
    ...
    public Response<Boolean> checkIfEmployeeHasConstraint(Date shiftDate, String shiftTime, String empId) {
    ...
    public Response<?> updateShiftStructure(String jobTitle, int amount, int day, String shiftTime){
    ...
    public Response<String> printIncompleteShifts() {
        String message = shiftController.printIncompleteShifts();
        return new Response<String>(message);
    }

    public Response<Boolean> checkIncompleteShifts(){
